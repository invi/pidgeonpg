...
function Logger(title) {
  ...
  this.error = function() {
    ...
    if (Object.prototype.toString.call(arg0).indexOf("WorkerErrorEvent")) {
      this.log("Worker Error: " + arg0.message);
      this.log("Worker Error filename: " + arg0.filename);
      this.log("Worker Error line no: " + arg0.lineno);
    } else if (Object.prototype.toString.call(arg0).indexOf("Error")) {
      console.trace();
